...
Unit * newUnit(string tla, Rank rank){
	...
	if(tla=="aaa")return new aaa(0,0,hp,up,rank,false,tla);
...
///*
	...
	if(tla=="dl8")return new dl8(0,0,hp,up,rank,false,tla);
	if(tla=="jgb")return new jgb(0,0,hp,up,rank,false,tla);
	if(tla=="pts")return new pts(0,0,hp,up,rank,false,tla);
	if(tla=="abb")return new abb(0,0,hp,up,rank,false,tla);
	...
	if(tla=="aia")return new aia(0,0,hp,up,rank,false,tla);
	if(tla=="akf")return new akf(0,0,hp,up,rank,false,tla);
	if(tla=="alp")return new alp(0,0,hp,up,rank,false,tla);
	if(tla=="alt")return new alt(0,0,hp,up,rank,false,tla);
	if(tla=="amo")return new amo(0,0,hp,up,rank,false,tla);
	if(tla=="aqa")return new aqa(0,0,hp,up,rank,false,tla);
	if(tla=="ark")return new ark(0,0,hp,up,rank,false,tla);
	if(tla=="asd")return new asd(0,0,hp,up,rank,false,tla);
	if(tla=="asn")return new asn(0,0,hp,up,rank,false,tla);
	if(tla=="avb")return new avb(0,0,hp,up,rank,false,tla);
	if(tla=="bac")return new bac(0,0,hp,up,rank,false,tla);
	if(tla=="bbq")return new bbq(0,0,hp,up,rank,false,tla);
	if(tla=="ben")return new ben(0,0,hp,up,rank,false,tla);
	if(tla=="blk")return new blk(0,0,hp,up,rank,false,tla);
	...
	if(tla=="brn")return new brn(0,0,hp,up,rank,false,tla);
	...
	if(tla=="cdy")return new cdy(0,0,hp,up,rank,false,tla);
	if(tla=="cjk")return new cjk(0,0,hp,up,rank,false,tla);
	...
	if(tla=="dmr")return new dmr(0,0,hp,up,rank,false,tla);
	if(tla=="dnd")return new dnd(0,0,hp,up,rank,false,tla);
	if(tla=="doh")return new doh(0,0,hp,up,rank,false,tla);
	...
	if(tla=="eob")return new eob(0,0,hp,up,rank,false,tla);
	if(tla=="fed")return new fed(0,0,hp,up,rank,false,tla);
	if(tla=="frp")return new frp(0,0,hp,up,rank,false,tla);
	...
	if(tla=="ham")return new ham(0,0,hp,up,rank,false,tla);
	...
	if(tla=="icm")return new icm(0,0,hp,up,rank,false,tla);
	if(tla=="ike")return new ike(0,0,hp,up,rank,false,tla);
	if(tla=="ipm")return new ipm(0,0,hp,up,rank,false,tla);
	if(tla=="jac")return new jac(0,0,hp,up,rank,false,tla);
	if(tla=="jax")return new jax(0,0,hp,up,rank,false,tla);
	if(tla=="jaz")return new jaz(0,0,hp,up,rank,false,tla);
	if(tla=="jbp")return new jbp(0,0,hp,up,rank,false,tla);
	if(tla=="jcd")return new jcd(0,0,hp,up,rank,false,tla);
	...
	if(tla=="jej")return new jej(0,0,hp,up,rank,false,tla);
	if(tla=="jen")return new jen(0,0,hp,up,rank,false,tla);
	if(tla=="jjc")return new jjc(0,0,hp,up,rank,false,tla);
	...
	if(tla=="jon")return new jon(0,0,hp,up,rank,false,tla);
	...
	if(tla=="jtb")return new jtb(0,0,hp,up,rank,false,tla);
	...
	if(tla=="kgb")return new kgb(0,0,hp,up,rank,false,tla);
	if(tla=="kjh")return new kjh(0,0,hp,up,rank,false,tla);
	if(tla=="kjs")return new kjs(0,0,hp,up,rank,false,tla);
	...
	if(tla=="krg")return new krg(0,0,hp,up,rank,false,tla);
	if(tla=="lam")return new lam(0,0,hp,up,rank,false,tla);
	if(tla=="lav")return new lav(0,0,hp,up,rank,false,tla);
	if(tla=="lea")return new lea(0,0,hp,up,rank,false,tla);
	...
	if(tla=="liv")return new liv(0,0,hp,up,rank,false,tla);
	if(tla=="lmn")return new lmn(0,0,hp,up,rank,false,tla);
	if(tla=="lol")return new lol(0,0,hp,up,rank,false,tla);
	if(tla=="loz")return new loz(0,0,hp,up,rank,false,tla);
	if(tla=="lpc")return new lpc(0,0,hp,up,rank,false,tla);
	if(tla=="lsd")return new lsd(0,0,hp,up,rank,false,tla);
	if(tla=="m11")return new m11(0,0,hp,up,rank,false,tla);
	if(tla=="maa")return new maa(0,0,hp,up,rank,false,tla);
	if(tla=="mab")return new mab(0,0,hp,up,rank,false,tla);
	if(tla=="mad")return new mad(0,0,hp,up,rank,false,tla);
	if(tla=="mar")return new mar(0,0,hp,up,rank,false,tla);
	if(tla=="med")return new med(0,0,hp,up,rank,false,tla);
	if(tla=="meh")return new meh(0,0,hp,up,rank,false,tla);
	...
	if(tla=="noo")return new noo(0,0,hp,up,rank,false,tla);
	...
	if(tla=="pig")return new pig(0,0,hp,up,rank,false,tla);
	...
	if(tla=="rar")return new rar(0,0,hp,up,rank,false,tla);
	...
	if(tla=="tkg")return new tkg(0,0,hp,up,rank,false,tla);
	...
	if(tla=="tru")return new tru(0,0,hp,up,rank,false,tla);
	if(tla=="tsm")return new tsm(0,0,hp,up,rank,false,tla);
	if(tla=="usa")return new usa(0,0,hp,up,rank,false,tla);
	if(tla=="usm")return new usm(0,0,hp,up,rank,false,tla);
	if(tla=="usu")return new usu(0,0,hp,up,rank,false,tla);
	if(tla=="vga")return new vga(0,0,hp,up,rank,false,tla);
	if(tla=="vs8")return new vs8(0,0,hp,up,rank,false,tla);
	if(tla=="wat")return new wat(0,0,hp,up,rank,false,tla);
	if(tla=="win")return new win(0,0,hp,up,rank,false,tla);
	if(tla=="wmf")return new wmf(0,0,hp,up,rank,false,tla);
	if(tla=="wmj")return new wmj(0,0,hp,up,rank,false,tla);
	if(tla=="wnd")return new wnd(0,0,hp,up,rank,false,tla);
	if(tla=="wnw")return new wnw(0,0,hp,up,rank,false,tla);
	if(tla=="xcd")return new xcd(0,0,hp,up,rank,false,tla);
	if(tla=="xxx")return new xxx(0,0,hp,up,rank,false,tla);
	if(tla=="yak")return new yak(0,0,hp,up,rank,false,tla);
	if(tla=="yep")return new yep(0,0,hp,up,rank,false,tla);
	if(tla=="yhg")return new yhg(0,0,hp,up,rank,false,tla);
	if(tla=="zio")return new zio(0,0,hp,up,rank,false,tla);
	if(tla=="zmk")return new zmk(0,0,hp,up,rank,false,tla);
	if(tla=="zrk")return new zrk(0,0,hp,up,rank,false,tla);
	if(tla=="zwh")return new zwh(0,0,hp,up,rank,false,tla);
	if(tla=="zzt")return new zzt(0,0,hp,up,rank,false,tla);
...
bool oneLeft(Unit *u[NUM]){
	...
	if(numTurns>MAXTURNS){
		...
		for(i=0;i<numplayers;++i){
			if(totalHp(u,i)==maxHp){
				cout << tla[i]<<" has the most armies! ("<<totalHp(u,i)<<")\n";
				numWinners++;
			}
		}
		if(numWinners>1){
	...
	if(i==NUM){
		//both kings are dead
		cout << "All crowns die! Everyone wins. \n";
		return true;
	}
